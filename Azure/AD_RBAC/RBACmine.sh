...
az ad user create --display-name devopsbot --password OpsBotDev123! --user-principal-name devopsbot@devops10000001outlook.onmicrosoft.com --force-change-password-next-login true --immutable-id devopsbot
az ad user create --display-name devopsbot2 --password OpsBotDev123! --user-principal-name devopsbot2@devops10000001outlook.onmicrosoft.com --force-change-password-next-login true --immutable-id devopsbot2
